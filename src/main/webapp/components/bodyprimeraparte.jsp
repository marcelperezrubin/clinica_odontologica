...
<body id="page-top">
     ...
     <!-- Aqui vamos a poner una validación de la Session -->
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <!-- <%=request.getSession().getAttribute("usuario")%> con Esto lo que estamos haciendo es que con mi sesion actual
                        nos diga el nombre del "usuario" que esta logeado-->
